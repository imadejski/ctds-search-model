...
model_base_path="/opt/gpudata/imadejski/image_text_global_local_alignment/param_search_v2"
output_base_path="/opt/gpudata/imadejski/search-model/ctds-search-model/data/param_search_v2"
split_type="validate"

# Define the model configurations
model_configs=("model_run_0_False_igl_tgl" "model_run_1_False_igl_tg" "model_run_2_False_ig_tgl" "model_run_3_False_ig_tg")
